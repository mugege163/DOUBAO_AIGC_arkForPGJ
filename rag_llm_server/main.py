    ...
    if action == "StartVoiceChat":
        request_body = {
            ...
            "AgentConfig": {
                ...
                "WelcomeMessage": "我是票管家Ai客服，你的专属购票指导助手，有什么问题尽管问我吧，我比铁小智更明白你哦！",
                "UserId": "AiAgent",
...
async def debug_chat(request: DebugRequest):
    ...
    async def generate_text():
        ...
        print(f"DEBUG: 票管家知识库查询耗时: {rag_duration:.2f}s")
        # print(f"DEBUG: 票管家知识库返回检索内容: {rag_content}")
...
async def debug_rag(query: str):
    ...
    print(f"🔍 [票管家Debug] 正在检索购票知识库: {query}")
